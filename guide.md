...
| inlineStylesheet         | true                                 | whether to inline the css contents of <link rel="stylesheet"> elements in the recording. by default, it will only inline stylesheets that are CORs accessible. refer to the [asset capture documentation](./docs/recipes/assets.md) for more options.                                 |
...
| inlineImages             | false                                | whether to record image content. this will use asset capturing on all images irrespective of their origin domain. refer to the [asset capture documentation](./docs/recipes/assets.md)                                                                                                                 |
