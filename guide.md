...
| inlineStylesheet         | true               | whether to inline the stylesheet in the events. Note: this will be superseded by `captureAssets` config in 2.1, but will continue to serve as a shorthand to configure how assets are captured as stylesheets                                                                                                                                                |
...
| inlineImages             | false              | whether to record the image content. Note: this will be superseded by `captureAssets` config in 2.1, but will continue to serve as a shorthand to configure whether image assets are captured                                                                                                                                                           |
