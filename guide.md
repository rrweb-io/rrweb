...
| blockClass               | 'rr-block'         | Use a string or RegExp to configure which elements should be blocked, refer to the [privacy guide](./docs/recipes/privacy.md)                                                                 |
...
| maskTextClass            | 'rr-mask'          | Use a string or RegExp to configure which elements should be masked, refer to the [privacy guide](./docs/recipes/privacy.md)                                                                  |
| maskTextSelector         | null               | Use a string to configure which selector should be masked, refer to the [privacy guide](./docs/recipes/privacy.md)                                                                            |
