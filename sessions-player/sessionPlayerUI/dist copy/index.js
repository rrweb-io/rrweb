var rrwebPlayer = (function() {
  ...
  function Switch(options) {
    ...
    if (!('id' in this._state))
      console.warn("<Switch> was created without expected data property 'id'");
    if (!('checked' in this._state))
      console.warn("<Switch> was created without expected data property 'checked'");
    if (!('label' in this._state))
      console.warn("<Switch> was created without expected data property 'label'");
  ...
  function create_if_block(component, ctx) {
    var div5,
      div3,
      span0,
      text0_value = formatTime(ctx.currentTime),
      text0,
      text1,
      div2,
      div0,
      ...
      text3,
      span1,
      text4_value = formatTime(ctx.meta.totalTime),
      text4,
      text5,
      div4,
      button0,
    ...
    return {
      ...
      p: function update(changed, _ctx) {
        ctx = _ctx;
        if (
          (!current || changed.currentTime) &&
          text0_value !== (text0_value = formatTime(ctx.currentTime))
        ) {
        ...
        if (
          (!current || changed.meta) &&
          text4_value !== (text4_value = formatTime(ctx.meta.totalTime))
        ) {
    ...
    return {
      c: function create() {
        ...
        setAttribute(
          path,
          'd',
          'M170.65984 896l0-768 640 384zM644.66944 512l-388.66944-233.32864 0 466.65728z',
        );
  ...
  function Controller(options) {
    ...
    if (!('replayer' in this._state))
      console.warn("<Controller> was created without expected data property 'replayer'");
    if (!('currentTime' in this._state))
      console.warn("<Controller> was created without expected data property 'currentTime'");

    if (!('showController' in this._state))
      console.warn("<Controller> was created without expected data property 'showController'");
    if (!('isSkipping' in this._state))
      console.warn("<Controller> was created without expected data property 'isSkipping'");

    if (!('isPlaying' in this._state))
      console.warn("<Controller> was created without expected data property 'isPlaying'");
    if (!('speed' in this._state))
      console.warn("<Controller> was created without expected data property 'speed'");
    if (!('skipInactive' in this._state))
      console.warn("<Controller> was created without expected data property 'skipInactive'");
    this._intro = !!options.intro;
  ...
  Controller.prototype._checkReadOnly = function _checkReadOnly(newState) {
    if ('meta' in newState && !this._updatingReadonlyProperty)
      throw new Error("<Controller>: Cannot set read-only property 'meta'");
    if ('percentage' in newState && !this._updatingReadonlyProperty)
      throw new Error("<Controller>: Cannot set read-only property 'percentage'");
  };
  ...
  Controller.prototype._recompute = function _recompute(changed, state) {
    ...
    if (changed.currentTime || changed.meta) {
      if (this._differs(state.percentage, (state.percentage = percentage(state))))
        changed.percentage = true;
    }
  };
  ...
  function Player(options) {
    ...
    if (!('width' in this._state))
      console.warn("<Player> was created without expected data property 'width'");
    if (!('height' in this._state))
      console.warn("<Player> was created without expected data property 'height'");

    if (!('replayer' in this._state))
      console.warn("<Player> was created without expected data property 'replayer'");
    if (!('showController' in this._state))
      console.warn("<Player> was created without expected data property 'showController'");
    if (!('autoPlay' in this._state))
      console.warn("<Player> was created without expected data property 'autoPlay'");
    this._intro = !!options.intro;
  ...
  Player.prototype._checkReadOnly = function _checkReadOnly(newState) {
    if ('style' in newState && !this._updatingReadonlyProperty)
      throw new Error("<Player>: Cannot set read-only property 'style'");
    if ('playerStyle' in newState && !this._updatingReadonlyProperty)
      throw new Error("<Player>: Cannot set read-only property 'playerStyle'");
  };
  ...
  Player.prototype._recompute = function _recompute(changed, state) {
    if (changed.width || changed.height) {
      ...
      if (this._differs(state.playerStyle, (state.playerStyle = playerStyle(state))))
        changed.playerStyle = true;
    }
  };
