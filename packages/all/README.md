...
- [rrweb](../rrweb)
- [@junify-app/record](../record)
- [@junify-app/replay](../replay)
- [@junify-app/packer](../packer)

## Installation

```bash
npm install @junify-app/all
```

## Usage

```js
import { record, replay, pack, unpack } from '@junify-app/all';
