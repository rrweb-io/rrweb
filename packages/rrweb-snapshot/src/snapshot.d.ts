import type { MaskInputOptions, SlimDOMOptions, MaskTextFn, MaskInputFn, KeepIframeSrcFn } from './types';
import type { serializedNodeWithId, serializedElementNodeWithId, DataURLOptions } from '@rrweb/types';
