...
declare module '$env/static/private' {
	...
	export const KEVIN_PSI_KEY: string;
	...
	export const WEBFLOW_TOKEN: string;
	...
	export const DISABLE_ESLINT_PLUGIN: string;
	...
	export const USERLEAP_HOME: string;
	...
	export const TSC_COMPILE_ON_ERROR: string;
	...
	export const SPRIG_HOME: string;
	...
	export const CLICKHOUSE_PASSWORD_STAGING: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CLICKHOUSE_PASSWORD_STAGING: string;
