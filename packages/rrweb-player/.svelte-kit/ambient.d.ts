...
declare module '$env/static/private' {
	...
	export const LT_ACCESS_KEY: string;
	...
	export const LT_USERNAME: string;
	...
	export const npm_config___artifacts_datanerd_us_artifactory_api_npm_newrelic_js_local__always_auth: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config___artifacts_datanerd_us_artifactory_api_npm_newrelic_js_local__always_auth: string;
		LOGNAME: string;
