...
import { EventType, IncrementalSource } from '@trail-limited/rrweb';
...
/**
 * Forked from '@trail-limited/rrweb' replay/index.ts. The original function is not exported.
...
// Forked from '@trail-limited/rrweb' replay/index.ts. A const threshold of inactive time.
