...
export declare function getUntaintedPrototype<
  T extends keyof BasePrototypeCache,
>(key: T): BasePrototypeCache[T];
export declare function getUntaintedAccessor<
...
export declare function getUntaintedMethod<
  K extends keyof BasePrototypeCache,
  T extends keyof BasePrototypeCache[K],
