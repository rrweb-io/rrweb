...
3. Run `npm run dev` in the root to get auto-building for all the sub-packages whenever you modify anything.
4. Navigate to one of the sub-packages (in the `packages` folder) where you'd like to make a change.
5. Patch the code and run `npm test` to run the tests, make sure they pass before you commit anything.
