...
export declare function initScrollObserver({ scrollCb, doc, mirror, blockSelector, sampling, }: Pick<observerParam, 'scrollCb' | 'doc' | 'mirror' | 'blockSelector' | 'sampling'>): listenerHandler;
