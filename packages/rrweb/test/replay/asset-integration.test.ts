...
import events from './fixtures/assets';
import mutationEvents from './fixtures/assets-mutation';
import assetsChangedEvents from './fixtures/assets-src-changed-before-asset-loaded';
import assetsBodyInlineStyleEvents from './fixtures/assets-body-inline-style';
import { EventType, type assetEvent } from '@rrweb/types';
