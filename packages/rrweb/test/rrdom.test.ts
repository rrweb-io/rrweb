...
import type { styleDeclarationData, styleSheetRuleData } from '@newrelic/rrweb-types';
import { createMirror, Mirror as NodeMirror } from '@newrelic/rrweb-snapshot';
import type { ReplayerHandler } from '@newrelic/rrdom';
