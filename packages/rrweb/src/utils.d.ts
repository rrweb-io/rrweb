...
export declare function closestElementOfNode(
  node: Node | null,
): HTMLElement | null;
...
export declare function legacy_isTouchEvent(
...
export declare function isSerializedIframe<TNode extends Node | RRNode>(
  n: TNode,
  mirror: IMirror<TNode>,
): boolean;
export declare function isSerializedStylesheet<TNode extends Node | RRNode>(
  n: TNode,
  mirror: IMirror<TNode>,
): boolean;
...
export declare function hasShadowRoot<T extends Node | RRNode>(
  n: T,
): n is T & {
  shadowRoot: ShadowRoot;
};
export declare function getNestedRule(
  rules: CSSRuleList,
  position: number[],
): CSSGroupingRule;
...
export declare function uniqueTextMutations(
