...
import type { IMirror, serializedNodeWithId, canvasMutationData, canvasEventWithTime, inputData, scrollData, styleSheetRuleData, styleDeclarationData } from '@newrelic/rrweb-types';
import { BaseRRNode as RRNode, BaseRRCDATASection, BaseRRComment, BaseRRDocument, BaseRRDocumentType, BaseRRElement, BaseRRMediaElement, BaseRRText, type IRRDocument, type IRRElement, type IRRNode, BaseRRDialogElement } from './document';
