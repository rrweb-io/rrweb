var rrwebRecord = (function() {
  ...
  function s(t, o, a, i, l, d, f) {
    void 0 === l && (l = !1), void 0 === d && (d = !0), void 0 === f && (f = !1);
    var p,
      h = (function(t, n, o, a, i) {
        switch (t.nodeType) {
          ...
          case t.ELEMENT_NODE:
            var s = !1;
            'string' == typeof o
              ? (s = t.classList.contains(o))
              : t.classList.forEach(function(e) {
                  o.test(e) && (s = !0);
                });
            for (
              var l = t.tagName.toLowerCase(), d = {}, f = 0, p = Array.from(t.attributes);
              f < p.length;
              f++
            ) {
              var h = p[f],
                ...
                v = h.value;
              d[m] =
                'src' === m || 'href' === m ? c(n, v) : 'style' === m ? u(v, location.href) : v;
            }
            if ('link' === l && a) {
              var y,
            ...
            if (
              ('style' === l &&
                ...
                (y = r(t.sheet)) &&
                (d._cssText = u(y, location.href)),
              ('input' !== l && 'textarea' !== l && 'select' !== l) ||
                ((v = t.value),
                'radio' !== d.type && 'checkbox' !== d.type && v
                  ? (d.value = i ? '*'.repeat(v.length) : v)
                  : t.checked && (d.checked = t.checked)),
              'option' === l)
            ) {
              var E = t.parentElement;
              d.value === E.value && (d.selected = t.selected);
            }
            if (s) {
    ...
    p = '__sn' in t ? t.__sn.id : n++;
    var m = Object.assign(h, { id: p });
    (t.__sn = m), (a[p] = t);
    var v = !l;
    if (
      (m.type === e.Element && ((v = v && !m.needBlock), delete m.needBlock),
      (m.type === e.Document || m.type === e.Element) && v)
    )
      for (var y = 0, g = Array.from(t.childNodes); y < g.length; y++) {
        var E = s(g[y], o, a, i, l, d, f);
    ...
    var o = new MutationObserver(function(o) {
        ...
        h = function(e, n) {
          if (!E(e, t)) {
            if (T(e)) {
              d.add(e);
              var r = null;
              n && T(n) && (r = n.__sn.id), r && (p[N(e.__sn.id, r)] = !0);
      ...
      o.forEach(function(e) {
        ...
        switch (n) {
          case 'characterData':
            var y = r.textContent;
            E(r, t) || y === o || a.push({ value: y, node: r });
            break;
          case 'attributes':
            y = r.getAttribute(v);
            if (E(r, t) || y === o) return;
            ...
            g || ((g = { node: r, attributes: {} }), i.push(g)), (g.attributes[v] = y);
            break;
          case 'childList':
                ...
                E(e, t) ||
                  (l.has(e)
                    ...
                    : (l.has(r) && -1 === n) ||
                      ...
                      (d.has(e) && p[N(n, o)] ? C(d, e) : u.push({ parentId: o, id: n })),
      ...
      var g = {
        texts: a
          .map(function(e) {
            return { id: m.getId(e.node), value: e.value };
          })
          .filter(function(e) {
            return m.has(e.id);
          }),
        attributes: i
          .map(function(e) {
            return { id: m.getId(e.node), attributes: e.attributes };
          })
          .filter(function(e) {
            return m.has(e.id);
          }),
              ...
              return function(r) {
                if (!E(r.target, t)) {
                  var o = m.getId(r.target),
                    a = b(r) ? r.changedTouches[0] : r,
                    i = a.clientX,
                    u = a.clientY;
                  e({ type: p[n], id: o, x: i, y: u });
                }
              };
            })(r);
          n.push(l(o, a));
  ...
  function _(e, n, r, o) {
    function a(e) {
      var t = e.target;
      if (t && t.tagName && !(M.indexOf(t.tagName) < 0) && !E(t, n)) {
        var a = t.type;
        if ('password' !== a && !t.classList.contains(r)) {
          ...
          'radio' === a || 'checkbox' === a
            ? (c = t.checked)
            : s && o && (u = '*'.repeat(u.length)),
            i(t, { text: u, isChecked: c });
          var l = t.name;
          'radio' === a &&
            l &&
            c &&
            document.querySelectorAll('input[type="radio"][name="' + l + '"]').forEach(function(e) {
              e !== t && i(e, { text: e.value, isChecked: !c });
            });
        }
      }
    }
  ...
  function L(e) {
    var t,
      ...
      a,
      i,
      u = I(e.mutationCb, e.blockClass, e.inlineStylesheet, e.maskAllInputs),
      c =
        ((t = e.mousemoveCb),
        (r = []),
        (o = v(function(e) {
        ...
        (a = v(
          function(e) {
            var t = e.target,
              a = b(e) ? e.changedTouches[0] : e,
              i = a.clientX,
              u = a.clientY;
            n || (n = Date.now()),
              r.push({ x: i, y: u, id: m.getId(t), timeOffset: Date.now() - n }),
              o(b(e));
          },
          16,
          { trailing: !1 },
        )),
        (i = [l('mousemove', a), l('touchmove', a)]),
        function() {
          i.forEach(function(e) {
            return e();
          });
        }),
      s = S(e.mouseInteractionCb, e.blockClass),
      d = (function(e, t) {
        return l(
          'scroll',
          v(function(n) {
            if (n.target && !E(n.target, t)) {
      ...
      h = _(e.inputCb, e.blockClass, e.ignoreClass, e.maskAllInputs);
    return function() {
      u.disconnect(), c(), s(), d(), p(), h();
    };
  }
  function O(e) {
  ...
  function A(e) {
    ...
    function w(e) {
      void 0 === e && (e = !1),
        D(O({ type: d.Meta, data: { href: window.location.href, width: g(), height: y() } }), e);
    ...
    D = function(e, t) {
      if ((r(e, t), e.type === d.FullSnapshot)) (n = e), (C = 0);
    ...
    try {
      ...
      N.push(
        l('DOMContentLoaded', function() {
          D(O({ type: d.DomContentLoaded, data: {} }));
        }),
      );
      var T = function() {
        w(),
          N.push(
            L({
              mutationCb: function(e) {
                return D(O({ type: d.IncrementalSnapshot, data: t({ source: f.Mutation }, e) }));
              },
              mousemoveCb: function(e, t) {
                return D(O({ type: d.IncrementalSnapshot, data: { source: t, positions: e } }));
              },
              mouseInteractionCb: function(e) {
                return D(
                  O({ type: d.IncrementalSnapshot, data: t({ source: f.MouseInteraction }, e) }),
                );
              },
              scrollCb: function(e) {
                return D(O({ type: d.IncrementalSnapshot, data: t({ source: f.Scroll }, e) }));
              },
              viewportResizeCb: function(e) {
                return D(
                  O({ type: d.IncrementalSnapshot, data: t({ source: f.ViewportResize }, e) }),
                );
              },
              inputCb: function(e) {
                return D(O({ type: d.IncrementalSnapshot, data: t({ source: f.Input }, e) }));
              },
              blockClass: u,
              ignoreClass: p,
              maskAllInputs: b,
  ...
  return (
    (A.addCustomEvent = function(e, t) {
      ...
      D(O({ type: d.Custom, data: { tag: e, payload: t } }));
    }),
    A
  );
})();
